...
const Footer = () => {
    return (
        ...
        <div className="container px-5 md:px-28 py-14 mt-20 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        ...
        <div className="bg-gray-800 bg-opacity-75 px-24">
