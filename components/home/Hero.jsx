...
const Hero = () => {
  ...
  <motion.div
    ...
    transition={{ duration: 0.8 }} className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 className="font-heading title-font sm:text-5xl text-3xl mb-4 font-medium text-white">Give your inner self a hugg
       
      </h1>
      <p className="mb-8 leading-relaxed font-medium">Anxious, stressed, or feeling lost? We got ears for you.
Get a shrink online with us.</p>
      <div className="flex justify-center">
      <motion.button
           whileHover={{ scale: 1.2 }}
           whileTap={{ scale: 0.9 }}
           transition={{ type: "spring", stiffness: 400, damping: 15 }} className="inline-flex font-medium  bg-blue-500 border-0 py-3 px-8 focus:outline-none  rounded text-2xl"><Link href="/#contactUs "><span className="flex"> Contact Us <EnvelopeIcon className="w-7 ml-3" strokeWidth={2.5}/></span></Link></motion.button>
     ...
     transition={{ duration: 0.8 }} className=" md:w-2/5 w-5/6">
      <img className="object-cover object-center rounded" alt="hero" src="/assets/huggHero.png"/>
  </motion.div>
    </div>
</section>
        </>
